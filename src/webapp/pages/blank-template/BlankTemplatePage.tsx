...
export default function BlankTemplatePage ({settings}: RouteComponentProps){
    ...
    <React.Fragment>
        ...
        <DialogContentText>{i18n.t("It seems this user account does not have any permission."
            + " Please get in touch with the admin if you need access to these sections.")}</DialogContentText>
    </React.Fragment>
        )
}
