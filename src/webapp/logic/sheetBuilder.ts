...
export class SheetBuilder {
    ...
    private getVersion() {
        const { element, useAutogeneratedTemplate = false } = this.builder;
        const { id: defaultVersion } = getTemplateId(element.type, element.id, useAutogeneratedTemplate);
...
export function getTemplateId(type: any, dataFormId: any, useAutogeneratedTemplate = false) {
    const dataFormId2 = useAutogeneratedTemplate ? dataFormId : undefined;
