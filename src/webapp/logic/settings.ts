...
import { autogeneratedTemplateId, DataFormTemplate } from "../../domain/entities/DataFormTemplate";
import {
...
export type PermissionSetting = "generation" | "settings" | "import" | "templates";
...
export default class Settings {
    ...
    static async build(api: D2Api, compositionRoot: CompositionRoot): Promise<Settings> {
        ...
        const permissions = {
            ...
            templates: await buildPermission("templates"),
        };
    ...
    async save(compositionRoot: CompositionRoot): Promise<OkOrError> {
        ...
        const data: AppSettings = {
            ...
            permissionsForTemplates: buildPermissions("templates"),
            ...
            allPermissionsForTemplates: permissions.templates.type === "all",
            orgUnitSelection,
            duplicateEnabled,
            duplicateExclusion,
            duplicateTolerance,
    ...
    getTemplateIdsForDataForm(dataForm: Maybe<Ref>): Id[] {
        ...
        if (dataForm && hasRelationships) {
            ...
            return [autogeneratedTemplateId];
        }
    }
...
function mapPermissionSettingToConfig(prop: PermissionSetting) {
    switch (prop) {
        ...
        case "templates":
            return "permissionsForTemplates";
    }
}
...
function mapPermissionSettingToAllConfig(prop: PermissionSetting) {
    switch (prop) {
        ...
        case "templates":
            return "allPermissionsForTemplates";
    }
}
