...
export default function SettingsFields({ settings, onChange }: SettingsFieldsProps) {
    ...
    const [isModuleTemplateDialogVisible, showModuleTemplateDialog] = useState<boolean>(true);
        ...
        <React.Fragment>
            ...
            <div className={classes.content}>
                ...
                <ListItem button onClick={() => showProgramStageFilterDialog(true)}>
                    ...
                    <ListItemText
                        primary={i18n.t("Custom Templates")}
                        secondary={i18n.t("Create, edit, and configure permissions for custom templates")}
                    />
                </ListItem>
            </div>
